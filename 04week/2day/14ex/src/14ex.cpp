...
int main() {
  ...
  Character human("Aragorn", HUMAN, 100, 22, 41);
  Character orc("Lurtz", ORC, 100, 22, 39);
  Character elf("Legolas", ELF, 110, 28, 25);
  Character dwarf("Gimli", DWARF, 60, 32, 41);

  human.attackTo(dwarf);
